<?php // $Id: menuedit.php,v 1.2 2008/03/23 09:11:38 julmis Exp $
 ...
 */
	...
	$url = $CFG->wwwroot.'/local/cms/menuedit.php?course='.$courseid;
    ...
    if ( $menu = $menuform->get_data() ) {
        ...
        redirect($CFG->wwwroot.'/local/cms/menus.php?course='.$course->id.'&amp;sesskey='.sesskey(), $message);
